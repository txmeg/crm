            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (i, e) {
                        ...
                        html += '<img title="zhangsan" src="image/user-thumbnail.png" style="width: 30px; height:30px;">';
                        html += '<div style="position: relative; top: -40px; left: 40px;" >';
                        html += '<h5 id="h'+e.id+'"> ' + e.noteContent + ' </h5>';
                        html += '<font color="gray">市场活动</font> <font color="gray">-</font> <b>${a.name}</b> <small id="s'+ e.id +'" style="color: gray;"> ' + (e.editFlag == 0 ? e.createTime : e.editTime) + ' 由' + (e.editFlag == 0 ? e.createBy : e.editBy) + '</small>';
                        html += '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
                        html += '<a class="myHref" href="javascript:void(0);" onclick="editRemark(\''+ e.id +'\')"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #0000FF;"></span></a>';
                        html += '&nbsp;&nbsp;&nbsp;&nbsp;';
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.success) {
                        ...
                        /*
                            showRemarkList();
                            这个方法不行，记录使用的是before方法，每一次删除之后，页面上都会保留原有的数据
                         */
...
<div id="remarkBody" style="position: relative; top: 30px; left: 40px;">
    ...
    <div class="remarkDiv" style="height: 60px;">
        ...
        <div style="position: relative; top: -40px; left: 40px;" >
            ...
            <font color="gray">市场活动</font> <font color="gray">-</font> <b>${a.name}}</b> <small style="color: gray;"> '+ e.editFlag==0?e.createTime:e.editTime+' 由'+ e.editFlag?e.createBy:e.editBy+'</small>
