...
<script type="text/javascript">
	...
	function showTranHistoryList() {
		...
		$.ajax({
			...
			url:"workbench/transaction/getTranListByTranId.do",
			data:{
				"tranId":"${t.id}"
			},
			type:"get",
...
<body>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		<%
			...
			//如果当前可能性为零，前面的七个一定是黑圈，后面俩个一个时红叉一个是黑叉
		...
		<span id="<%=i%>" onclick="changeStage('<%=stage%>','<%=i%>')"
			  ...
			  data-placement="bottom" data-content="<%=dicValueList.get(i).getText()%>" style="color: #FF0000;"></span>
		-----------
		<%
		...
		<span id="<%=i%>" onclick="changeStage('<%=stage%>','<%=i%>')"
			  class="glyphicon glyphicon-remove mystage" data-toggle="popover"
			  data-placement="bottom" data-content="<%=dicValueList.get(i).getText()%>" style="color: #000000;"></span>
		-----------
		<%
						}
		...
		<span id="<%=i%>" onclick="changeStage('<%=stage%>','<%=i%>')"
			  ...
			  data-placement="bottom" data-content="<%=dicValueList.get(i).getText()%>" style="color: rgb(0,0,0);"></span>
		-----------
		<%
		...
		<span id="<%=i%>" onclick="changeStage('<%=stage%>','<%=i%>')"
			  ...
			  data-placement="bottom" data-content="<%=dicValueList.get(i).getText()%>" style="color: #90F790;"></span>
		-----------
		<%
