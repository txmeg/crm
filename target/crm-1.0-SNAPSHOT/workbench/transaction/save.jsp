...
<body>
	...
	<form class="form-horizontal" role="form" style="position: relative; top: -30px;" action="workbench/transaction/save.do" method="post" id="saveForm">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activitySrc" value="发传单4">
				<input type="hidden" value="1ab7ccc10a7249239d969b205a5781a5" name="activityId"/>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-contactsName" value="马强东">
				<input type="hidden" value="53ccfb8ce02d436c9c67e3af2ed854e4" name="contactsId"/>
			</div>
		</div>
